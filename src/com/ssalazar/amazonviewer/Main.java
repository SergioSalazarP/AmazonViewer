package com.ssalazar.amazonviewer;
...
import com.ssalazar.amazonviewer.model.Book;
import com.ssalazar.amazonviewer.model.Chapter;
import com.ssalazar.amazonviewer.model.Magazine;
import com.ssalazar.amazonviewer.model.Movie;
import com.ssalazar.amazonviewer.model.Serie;
import com.ssalazar.util.AmazonUtil;
...
/**
 * <h1>AmazonViewer</h1>
 * AmazonViewer es un programa que permite vizualizar Movies, Series con su respectivos Chapsters,
 * Books y Magazines. Te permite generar reportes generales y con fecha del d�a.
 * <p>
 * Existen algunas reglas como que todos los elementos pueden ser visualizados o le�dos a excepci�n 
...
public class Main {
	...
	public static void showMenu() {
		...
		do {
			...
			System.out.println("");
			System.out.println("Selecciona el número de la opci�n deseada");
